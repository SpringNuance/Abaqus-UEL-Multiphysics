...
# Run by nguyenb5 on Thu Oct  3 14:33:39 2024
#
...
executeOnCaeStartup()
o2 = session.openOdb(name='cube_C3D8_diffusion.odb')
#: Model: C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UMATHT) cube_C3D8_diffusion/cube_C3D8_diffusion.odb
...
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.00235135, 
    farPlane=0.00496572, width=0.0027721, height=0.00124876, 
    viewOffsetX=8.55584e-05, viewOffsetY=-9.07938e-05)
...
#: Warning: The output database 'C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UMATHT) cube_C3D8_diffusion/cube_C3D8_diffusion.odb' disk file has changed.
#: 
#: The current plot operation has been canceled, re-open the file to view the results
o1 = session.openOdb(
    name='C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UMATHT) cube_C3D8_diffusion/cube_C3D8_diffusion.odb')
