...
options = {
    ...
    'importer':OFF,
    'importerParts':OFF,
    'includes':['processing_input_elastic_plate/nodes.inc', 'processing_input_elastic_plate/elements_UEL.inc', 'processing_input_elastic_plate/elements_VISUAL.inc'],
    'inertiarelief':OFF,
    'initialConditionsFile':OFF,
    'input':'elastic_plate_UEL',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'elastic_plate_UEL',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
