module userinputs
    ...
    integer, parameter :: ntensor = 6 ! Number of stress components
    integer, parameter :: ndirect = 3 ! Number of direct stress components
    integer, parameter :: nshear = 3 ! Number of shear stress components
