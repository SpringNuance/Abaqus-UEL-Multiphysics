...
! ============================== !
! Mode I displacement (Opening)  !
! ============================== !

subroutine DISP_MODE_I(u, kstep, kinc, time, node, noel, jdof, coords)
    ...
    ! Material + geometry
    xk  = 30.0d0 * sqrt(1000.0d0) * time(2)  ! MPa*sqrt(mm)
    ...
    ! --- Mode I displacement field: u_x and u_y based on polar form
    ...
    case (2)
        u(1) = uy
    case (3)
        u(1) = 0.0d0  ! Mode I has no displacement in z
    case default
        u(1) = 0.0d0
    end select
