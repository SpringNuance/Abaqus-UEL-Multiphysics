...
subroutine UFIELD(field, kfield, nsecpt, kstep, kinc, time, node, &
    ...
    print *, 'UFIELD is called for node = ', node
...
subroutine UEL(rhs,amatrx,svars,energy,ndofel,nrhs,nsvars, &
    ...
    real(kind=dp) :: u_hydro_kIP_t, u_hydro_kIP_tm1, dudt_hydro_kIP_t, du_hydro_kIP, r_hydro_kIP_t, drdt_hydro_kIP
    real(kind=dp), dimension(ndim) :: dudg_hydro_kIP_t, dudg_hydro_kIP_inter_t, dudg_hydro_kIP_extra_t
    real(kind=dp), dimension(ndim) :: flux_hydro_kIP, flux_hydro_kIP_t, flux_hydro_kIP_tm1, dfdt_hydro_kIP_t
    real(kind=dp), dimension(ndim,ndim) :: dfdg_hydro_kIP_t
    ...
    ! Concentration field: CL_mol_node1, CL_mol_node2, ..., CL_mol_nnode, 
    ...
    do kinpt=1,ninpt
        ...
        !     drplde,drpldt,stran,dstran,time,dtime,temp,dtemp,predef,dpred, &
        !     cmname,ndirect,nshear,ntensor,nstatv,props,nprops,coords,drot,pnewdt, &
        !     celent,dfgrd0,dfgrd1,noel,npt,layer,kspt,jstep,kinc)
