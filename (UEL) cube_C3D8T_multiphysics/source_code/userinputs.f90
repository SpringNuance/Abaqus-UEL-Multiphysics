...
module userinputs
	...
	integer, parameter :: deqplas_idx = 29 ! SDV index of equivalent plastic strain increment (1/s)
	integer, parameter :: sig_H_idx = 30 ! SDV index of hydrostatic stress (Pa)
	integer, parameter :: sig_H_grad_X_idx = 31 ! SDV index of hydrostatic stress gradient in X direction (Pa/m)
	integer, parameter :: sig_H_grad_Y_idx = 32 ! SDV index of hydrostatic stress gradient in Y direction (Pa/m)
	integer, parameter :: sig_H_grad_Z_idx = 33 ! SDV index of hydrostatic stress gradient in Z direction (Pa/m)
	integer, parameter :: sig_vonMises_idx = 34 ! SDV index of equivalent von Mises stress (Pa)
	integer, parameter :: sig_Tresca_idx = 35 ! SDV index of Tresca stress (Pa)
	integer, parameter :: sig_P1_idx = 36 ! SDV index of maximum principal stress (Pa)
	integer, parameter :: sig_P2_idx = 37 ! SDV index of middle principal stress (Pa)
	integer, parameter :: sig_P3_idx = 38 ! SDV index of minimum principal stress (Pa)
