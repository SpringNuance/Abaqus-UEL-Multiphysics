...
subroutine UMATHT(u,dudt,dudg,flux,dfdt,dfdg, &
    ...
    statev(flux_heat_X_idx) = flux(1)
    statev(flux_heat_Y_idx) = flux(2)
    statev(flux_heat_Z_idx) = flux(3)
...
subroutine UEL(rhs,amatrx,svars,energy,ndofel,nrhs,nsvars, &
    ...
    do kinpt=1,ninpt
        ...
        nprops_UMATHT = end_temp_props_idx - start_temp_props_idx + 1
        ...
        call UMATHT(u_heat_kIP,dudt_heat_kIP_t,dudg_heat_kIP_t, &
                                  ...
                                  nprops_UMATHT,coords_kelem_kIP_t, &
