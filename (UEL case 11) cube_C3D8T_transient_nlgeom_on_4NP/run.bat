...
abaqus job=subroutine_cube_C3D8T_transient_nlgeom_on_4NP_UEL user="source_code/UEL_multiphysics" cpus=1 mp_mode=threads -verbose 1 interactive ask_delete=off