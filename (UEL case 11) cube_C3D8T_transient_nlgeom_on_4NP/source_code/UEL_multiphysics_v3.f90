...
subroutine UEL(rhs,amatrx,svars,energy,ndofel,nrhs,nsvars, &
    ...
    do kinpt=1,ninpt
        ...
        ru_heat_kIP = du_heat_kIP - dudt_heat_kIP_t * dtemp_kIP/dtime
        ...
        ! F_du_heat_term_kIP_t = - N_shape_NP_to_kIP * rho_heat * (du_heat_kIP)
        ...
        F_heat_rhs_kIP_t = F_flux_heat_term_kIP_t + F_dudt_heat_term_kIP_t + F_ru_heat_term_kIP
