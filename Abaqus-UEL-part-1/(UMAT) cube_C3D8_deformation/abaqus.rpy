...
# Run by nguyenb5 on Thu Oct  3 13:03:49 2024
#
...
session.Viewport(name='Viewport: 1', origin=(0.0, 0.0), width=93.6145782470703, 
...
#: Model: C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UMAT) cube_C3D8_deformation/cube_C3D8_deformation.odb
...
session.viewports['Viewport: 1'].odbDisplay.display.setValues(plotState=(
    CONTOURS_ON_DEF, ))
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.00161134, 
    farPlane=0.00512839, width=0.00383166, height=0.00172607, 
    viewOffsetX=0.00030695, viewOffsetY=0.000190869)
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV13', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].view.setValues(width=0.00365861, 
    height=0.00164811, viewOffsetX=0.000302574, viewOffsetY=0.000172697)
...
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=100 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=100 )
#: Warning: The output database 'C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UMAT) cube_C3D8_deformation/cube_C3D8_deformation.odb' disk file has changed.
#: 
