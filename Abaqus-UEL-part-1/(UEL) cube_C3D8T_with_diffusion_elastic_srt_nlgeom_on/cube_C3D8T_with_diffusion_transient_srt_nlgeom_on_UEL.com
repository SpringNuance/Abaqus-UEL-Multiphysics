...
options = {
    ...
    'input':'cube_C3D8T_with_diffusion_transient_srt_nlgeom_on_UEL',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'cube_C3D8T_with_diffusion_transient_srt_nlgeom_on_UEL',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
    'user':'deformation_diffusion_UEL.f90',
    'verbose':1,
    'visco':OFF,
    'xplSelect':OFF,
}
