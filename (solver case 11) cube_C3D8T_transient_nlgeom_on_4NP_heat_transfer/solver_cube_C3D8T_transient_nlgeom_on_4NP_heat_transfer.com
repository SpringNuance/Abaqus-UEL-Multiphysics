...
options = {
    ...
    'input':'solver_cube_C3D8T_transient_nlgeom_on_4NP_heat_transfer',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'solver_cube_C3D8T_transient_nlgeom_on_4NP_heat_transfer',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':['matrixgenerate', 'elementmatrixoutput'],
    'no_domain_check':1,
    'numLoadCases':0,
    'onestepinverse':OFF,
    'outputKeywords':ON,
