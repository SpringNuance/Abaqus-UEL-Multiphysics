...
subroutine UEL(rhs,amatrx,svars,energy,ndofel,nrhs,nsvars, &
    ...
    real(kind=dp), dimension(ndim,ndim) :: xjac, xjaci, xjaci_bar                    ! Inverse of the Jacobian matrix 
...
!   initialising
    ...
    do kinpt=1,ninpt
        ...
        xjaci_bar = xjaci * (djac_bar/djac) **  third

        ! B_deriv_global_kinpt = matmul(xjaci,B_deriv_local_kinpt)
        B_deriv_global_kinpt = matmul(xjaci_bar,B_deriv_local_kinpt)
    ...
    B_deriv_global_center = matmul(xjaci_bar,B_deriv_local_center)
    ...
    dstran = matmul(Bu_center, du_prev)
    ! dstran = matmul(Bu_bar, du_prev_bar)
