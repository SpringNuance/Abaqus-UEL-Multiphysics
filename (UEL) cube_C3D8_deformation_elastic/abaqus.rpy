...
# Run by nguyenb5 on Wed Oct  9 20:45:08 2024
#
...
executeOnCaeStartup()
o2 = session.openOdb(name='cube_C3D8_deformation_solver.odb')
#: Model: C:/LocalUserData/User-data/nguyenb5/Abaqus-UEL-von-Mises-plasticity/(UEL) cube_C3D8_deformation_elastic/cube_C3D8_deformation_solver.odb
...
session.viewports['Viewport: 1'].odbDisplay.display.setValues(plotState=(
    CONTOURS_ON_DEF, ))
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.00235539, 
    farPlane=0.00493859, width=0.00295411, height=0.00133075, 
    viewOffsetX=-5.46222e-05, viewOffsetY=1.83464e-05)
...
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.00227631, 
    farPlane=0.00501767, width=0.00343724, height=0.00154839, 
    viewOffsetX=-7.46842e-05, viewOffsetY=2.8371e-05)
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.00239003, 
    farPlane=0.00500126, width=0.00360897, height=0.00162575, cameraPosition=(
    0.00171784, 0.00108688, 0.00308091), cameraUpVector=(-0.577885, 0.740397, 
    -0.343309), cameraTarget=(3.1127e-05, -8.51829e-07, 2.20315e-05), 
    viewOffsetX=-7.84154e-05, viewOffsetY=2.97884e-05)
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=0 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=1 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=2 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=3 )
